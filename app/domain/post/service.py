...
class PostService:
	...
	def create(self, data: CreatePost):
		...
		if post:
			return ResponsePost.model_dump(post)
	...
	def get_all(self):
		...
		if posts:
			return [ResponsePost.model_dump(p) for p in posts]
	...
	def update(self, post_id: int, data: UpdatePost):
		...
		if updated:
			return ResponsePost.model_dump(updated)
	...
	def delete(self, post_id: int):
		...
		if deleted:
			return ResponsePost.model_dump(deleted)
